...
<body>
    <div class=container>
        <h1>5 dienos užduotys</h1>
        <a href="task1.php">
            <h2>1.Parašykite funkciją, kuri priimtų masyvą ir išrikiuotų masyvo narius custom bubble sort metodu. Tą funkciją deklaruokite kitame faile, bet iškvieskite iš
